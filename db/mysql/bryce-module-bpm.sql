...
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (164, '用户分组', 'M', 6, 'bpm/userGroup/index', 'bpm:userGroup:page', 'icon-menu', 0, 4, null, 1, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (165, '流程实例', 'M', 6, 'bpm/process-instance/manager', 'bpm:process-instance:manager-page', 'icon-file-copy', 0, 5, '流程实例菜单', 1, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (166, '流程任务', 'M', 6, 'bpm/task/index', 'bpm:task:page', 'icon-carryout', 0, 6, '流程任务菜单', 1, 1, null, 1, now(), 1, now());
