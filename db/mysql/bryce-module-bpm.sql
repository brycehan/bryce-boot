...
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (164, '用户组管理', 'M', 6, 'bpm/user-group/index', 'bpm:user-group:page', 'icon-menu', 0, 4, null, 1, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (165, '流程监听器', 'M', 6, 'bpm/process-listener/index', 'bpm:process-listener:page', 'icon-file-copy', 0, 5, '流程实例菜单', 1, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (166, '流程表达式', 'M', 6, 'bpm/process-expression/index', 'bpm:process-pxpression:page', 'icon-file-copy', 0, 6, '流程实例菜单', 1, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (167, '流程实例', 'M', 6, 'bpm/process-instance/manager', 'bpm:process-instance:manager-page', 'icon-file-copy', 0, 7, '流程实例菜单', 1, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (168, '流程任务', 'M', 6, 'bpm/task/manager', 'bpm:task:manager-page', 'icon-carryout', 0, 8, '流程任务菜单', 1, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (171, '发起流程', 'M', 7, 'bpm/startProcess/index', 'bpm:start-process:page', 'icon-subnode', 0, 1, '发起流程菜单', 1, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (172, '我的流程', 'M', 7, 'bpm/process-instance/my', 'bpm:process-instance:my-page', 'icon-solution', 0, 2, '我的流程菜单', 1, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (173, '待办任务', 'M', 7, 'bpm/task/todo', 'bpm:task:todo-page', 'icon-edit', 0, 3, '待办流程菜单', 1, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (174, '已办任务', 'M', 7, 'bpm/task/done', 'bpm:task:done-page', 'icon-fileprotect', 0, 4, '已办流程菜单', 1, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (175, '抄送我的', 'M', 7, 'bpm/task/copy', 'bpm:task:copy-page', 'icon-snippets', 0, 5, '抄送我的菜单', 1, 1, null, 1, now(), 1, now());
