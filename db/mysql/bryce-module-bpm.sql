...
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (163, '流程分类', 'M', 6, 'bpm/category/index', 'bpm:category:page', 'ion:list-circle-outline', 0, 3, '流程分类菜单', 1, 1, null, 1, now(), 1, now());
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (164, '用户组管理', 'M', 6, 'bpm/user-group/index', 'bpm:user-group:page', 'ion:people-circle-outline', 0, 4, '用户组管理菜单', 1, 1, null, 1, now(), 1, now());
...
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, visible, status, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (175, '抄送我的', 'M', 7, 'bpm/task/copy', 'bpm:process-instance:copy-page', 'ion:copy-outline', 0, 5, '抄送我的菜单', 1, 1, null, 1, now(), 1, now());
