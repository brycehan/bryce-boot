...
INSERT INTO brc_sys_dict_data (id, dict_label, dict_value, dict_type_id, label_class, sort, status, remark, tenant_id, version, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (111, '正常', '1', 11, 'primary', 1, 1, null, null, 1, 0, 1, now(), null, null);
INSERT INTO brc_sys_dict_data (id, dict_label, dict_value, dict_type_id, label_class, sort, status, remark, tenant_id, version, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (112, '暂停', '2', 11, 'danger', 2, 1, null, null, 1, 0, 1, now(), null, null);
...
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, version, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (133, '定时任务日志', 'M', 4, 'quartz/jobLog/index', 'quartz:jobLog:page', 'icon-menu', 0, 3, null, 1, null, 0, 1, now(), null, null);
-- 三级菜单
...
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, version, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (1331, '定时任务日志新增', 'B', 133, null, 'quartz:jobLog:save', '', 0, 1, null, 1, null, 0, 1, now(), null, null);
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, version, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (1332, '定时任务日志修改', 'B', 133, null, 'quartz:jobLog:update', '', 0, 2, null, 1, null, 0, 1, now(), null, null);
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, version, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (1333, '定时任务日志删除', 'B', 133, null, 'quartz:jobLog:delete', '', 0, 3, null, 1, null, 0, 1, now(), null, null);
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, version, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (1334, '定时任务日志详情', 'B', 133, null, 'quartz:jobLog:info', '', 0, 4, null, 1, null, 0, 1, now(), null, null);
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, version, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (1335, '定时任务日志导出', 'B', 133, null, 'quartz:jobLog:export', '', 0, 5, null, 1, null, 0, 1, now(), null, null);
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, version, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (1336, '定时任务日志导入', 'B', 133, null, 'quartz:jobLog:import', '', 0, 6, null, 1, null, 0, 1, now(), null, null);
...
(
    ...
    primary key (id)
) engine InnoDB default charset utf8mb4 collate utf8mb4_0900_ai_ci comment 'quartz 定时任务调度表';
...
(
    ...
    created_time   datetime          null comment '创建时间'
) engine InnoDB default charset utf8mb4 collate utf8mb4_0900_ai_ci comment 'quartz 定时任务调度日志表';
