...
comment on column brc_sys_user.deleted is '删除标志（0：存在，1：删除）';
...
comment on column brc_sys_menu.deleted is '状态（false：正式数据，true：删除）';
...
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, version, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (3, '系统监控', 'M', 0, '', '', 'icon-Report', false, 3, '系统监控目录', true, null, false, 1, now(), null, null);
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, version, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (4, '系统工具', 'M', 0, '', '', 'icon-Report', false, 4, '系统工具目录', true, null, false, 1, now(), null, null);
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, version, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (5, '日志管理', 'M', 0, '', '', 'icon-filedone', false, 5, '系统日志目录', true, null, false, 1, now(), null, null);
-- 二级菜单
...
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, version, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (116, '通知公告', 'M', 2, 'system/notice/index', 'system:notice:page', 'icon-message-fill', false, 8, '通知公告菜单', true, null, false, 1, now(), null, null);
...
INSERT INTO brc_sys_menu (id, name, type, parent_id, url, authority, icon, open_style, sort, remark, status, version, deleted, created_user_id, created_time, updated_user_id, updated_time) VALUES (123, '缓存监控', 'M', 3, 'monitor/cache/index', 'monitor:cache:info', 'icon-fund-fill', false, 3, '缓存监控菜单', true, null, false, 1, now(), null, null);
...
comment on column brc_sys_dict_type.deleted is '删除标识（0：存在，1：删除）';
...
comment on column brc_sys_dict_data.deleted is '删除标识（0：存在，1：删除）';
