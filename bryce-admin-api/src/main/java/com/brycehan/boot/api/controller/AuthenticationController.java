...
public class AuthenticationController {
    ...
    public AuthenticationController(SysUserService sysUserService, SysPermissionService sysPermissionService, AuthenticationService authenticationService, SysMenuService sysMenuService) {
    ...
    public ResponseEntity<ResponseResult<LoginVo>> login(@Validated @RequestBody LoginDto loginDto) {
